...
- (id)initWithFrame:(CGRect)frame delegate:(MainViewController *)delegate;
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        UIButton *scanButton = [MyButtons buttonWithTitle:@"CLEAR KEYSTORE"
                                                         target:self
                                                       selector:@selector(clearKeystorePressed:)
        ...
        UIButton *refreshButton = [MyButtons buttonWithTitle:@"REFRESH"
                                                       target:self
...
//===================================================================================================================
- (void)clearKeystorePressed:(id)sender;
{
    DBLogMethod(@"%s");
    self.logTextView.text = @"";
    SEL selector = NSSelectorFromString(@"clearKeystore:");
...
- (void)refreshPressed:(id)sender;
{
    DBLogMethod(@"%s");
    self.logTextView.text = @"";
    SEL selector = NSSelectorFromString(@"refreshKeystore:");
    if ([delegate respondsToSelector:selector])
        [self.delegate performSelector:selector];
}
